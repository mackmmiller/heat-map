...
function graph(data) {
	...
	h=500,
	padding=60,
	parseTime=__WEBPACK_IMPORTED_MODULE_0_d3__["i" /* timeParse */]("%B-%Y"),
	parseMonth=__WEBPACK_IMPORTED_MODULE_0_d3__["i" /* timeParse */]("%m"),
	parseYear=__WEBPACK_IMPORTED_MODULE_0_d3__["i" /* timeParse */]("%Y");
	
	dataset.monthlyVariance.forEach((d)=>d.date=d.year+"-"+d.month);
	console.log(dataset);
	const div = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]("main").append("div")
		.attr("class","tooltip")
		.style("opacity", 0);

	const xScale = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* scaleTime */]()
						.domain([__WEBPACK_IMPORTED_MODULE_0_d3__["e" /* min */](dataset.monthlyVariance,(d)=>parseYear(d.year)),__WEBPACK_IMPORTED_MODULE_0_d3__["d" /* max */](dataset.monthlyVariance, (d)=>parseYear(d.year))])
						.range([padding,w-padding]);

	const yScale = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* scaleTime */]()
	...
	const svg = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]("main")
					.append("svg")
					.attr("width", w)
					.attr("height", h)
	...
	svg.selectAll("rect")
		...
		.on("mouseover", (d)=> {
			let parseDate = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* timeFormat */]("%m-%Y");
			let month = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* timeFormat */]("%B");
			let year = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* timeFormat */]("%Y")
	...
	//Y Axis
	const yAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* axisLeft */](yScale).tickFormat(__WEBPACK_IMPORTED_MODULE_0_d3__["h" /* timeFormat */]("%B"));
	svg.append("g")
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "h", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["a"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "i", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["b"]; });
...
// module
exports.push([module.i, "html, body {\n  height: 100%;\n  margin: 0; }\n\nbody {\n  background-color: #b9898f; }\n\nheader, footer {\n  background-color: #c7b08b; }\n\nheader {\n  padding: 1em; }\n\ndiv.tooltip {\n  position: absolute;\n  border: 3px solid #26c0b0;\n  border-radius: 5px;\n  background: #26C0B0;\n  pointer-events: none;\n  padding: 0.25em;\n  text-align: center; }\n\nsvg {\n  display: block;\n  margin: 10px auto; }\n  svg .title {\n    font-size: 24px;\n    text-decoration: underline; }\n  svg .subtitle {\n    font-size: 20px; }\n  svg .cool5 {\n    fill: #534698; }\n  svg .cool4 {\n    fill: #2C7DB5; }\n  svg .cool3 {\n    fill: #5BBA9B; }\n  svg .cool2 {\n    fill: #A1D89A; }\n  svg .cool1 {\n    fill: #E3F38D; }\n  svg .neutral {\n    fill: #FFFFB7; }\n  svg .warm1 {\n    fill: #FEDB80; }\n  svg .warm2 {\n    fill: #FDA457; }\n  svg .warm3 {\n    fill: #F3613B; }\n  svg .warm4 {\n    fill: #CF3646; }\n  svg .warm5 {\n    fill: #94003A; }\n\nfooter {\n  padding: 0.25em;\n  text-align: center;\n  color: white; }\n  footer a {\n    color: white; }\n", ""]);
